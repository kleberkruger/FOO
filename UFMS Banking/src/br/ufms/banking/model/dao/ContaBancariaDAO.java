...
public class ContaBancariaDAO<C extends Correntista> extends FileDAO<ContaBancaria<C>, Long> {
    ...
    @Override
    protected String encode(ContaBancaria<C> bean) throws PersistenceException {
    ...
    @Override
    protected ContaBancaria<C> decode(String info) throws PersistenceException {
        try {
            ...
            if (infos[0].equalsIgnoreCase(ContaCorrente.class.getSimpleName())) {
                ContaCorrente cc = new ContaCorrente(correntista);
                ...
                ContaPoupanca cp = new ContaPoupanca(correntista);
