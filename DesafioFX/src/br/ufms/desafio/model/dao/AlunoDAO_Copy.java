 ...
 * @author kleberkruger
 */
public class AlunoDAO_Copy extends JogadorDAO_Copy<Aluno> {

    protected AlunoDAO_Copy() {
        super(Aluno.class);
    }
...
//            LocalDate ingresso = bean.getIngresso();
...
//            ps.setDate(5, ingresso != null ? Date.valueOf(bean.getIngresso()) : null);
//            ps.executeUpdate();
//
//            conn.commit();
//
...
//                + "u.codigo = " + codigo;
System.out.println("SELECT * FROM desafio.usuario u WHERE u.codigo = " + codigo);
return "SELECT * FROM desafio.usuario u WHERE u.codigo = " + codigo;
    }
